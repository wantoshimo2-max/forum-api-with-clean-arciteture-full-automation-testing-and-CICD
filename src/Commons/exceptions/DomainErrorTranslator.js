...
DomainErrorTranslator._directories = {
  ...
  'REFRESH_AUTH.NOT_CONTAIN_REFRESH_TOKEN': new InvariantError('harus mengirimkan token refresh'),
  'REFRESH_AUTH.NOT_MEET_DATA_TYPE_SPECIFICATION': new InvariantError('refresh token harus string'),
  'DELETE_AUTH.NOT_CONTAIN_REFRESH_TOKEN': new InvariantError('harus mengirimkan token refresh'),
  'DELETE_AUTH.NOT_MEET_DATA_TYPE_SPECIFICATION': new InvariantError('refresh token harus string'),
  ...
  'NEW_THREAD.TITLE_LIMIT_CHAR': new InvariantError('tidak dapat membuat thread baru karena judul melebihi batas limit'),
